...
Get a space running in three steps.
...
- Learn about [Space & Kind](/docs/concepts/space-and-kind) in depth
- See how spaces link to each other via [Dependencies](/docs/concepts/dependencies)
