  ...
  return (
    <header className="flex items-center gap-4 px-5 py-3 border-b border-border">
      ...
      <span className="font-semibold text-text-primary text-sm tracking-wide">
        radium-fs <span className="text-text-secondary font-normal">playground</span>
      </span>
      ...
      <button
        onClick={onRun}
        disabled={running}
        className="px-4 py-1.5 rounded text-xs font-medium bg-radium-800 text-accent hover:bg-radium-700 disabled:opacity-40 transition-colors"
      >
